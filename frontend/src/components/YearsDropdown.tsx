...
export default function YearsDropdown({
  ...
  const getDisplayText = (year: number) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        disabled={disabled}
        className={`w-full px-3 md:px-4 py-2 md:py-3 text-left border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white text-gray-900 placeholder-gray-500 text-sm md:text-base ${
