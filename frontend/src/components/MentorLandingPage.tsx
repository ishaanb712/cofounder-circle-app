...
export default function MentorLandingPage() {
  ...
  const stats = [
    { number: '85%', label: 'of mentors find fulfillment in guiding the next generation.' },
    { number: '2.3×', label: 'more successful startups have experienced mentors.' },
    { number: '67%', label: 'of mentors expand their network through mentoring.' }
  ];

  const features = [
    {
      title: 'Mentorship Programs',
      description: 'Guide students and founders through their journey with structured mentorship programs.',
      icon: Users
    },
    {
      title: 'Expert Network',
      description: 'Connect with other experienced professionals and expand your influence.',
      icon: Star
    },
    {
      title: 'Knowledge Sharing',
      description: 'Share your expertise and help shape the future of entrepreneurship.',
      icon: BookOpen
    },
    {
      title: 'Impact Opportunities',
      description: 'Make a real difference in the startup ecosystem and leave a lasting legacy.',
      icon: Lightbulb
    }
  ];
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <p>You want to give back, but finding the right mentees is hard.</p>
              <br />
              <p>You have valuable experience, but the platforms are filled with time-wasters and non-serious people.</p>
              <br />
              <p>If you're not from a top company or don't have a massive network, your wisdom goes to waste. Because everyone wants guidance but no one wants to filter for quality.</p>
              <br />
              <p style={{ fontWeight: 700 }}>Sound familiar? </p>
              <p>It's not your fault. The system wasn't built for quality connections.</p>
            </div>
          </motion.div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              CoFounder Circle is India's First Startup Network Built to Empower Mentors.
            </h2>
            <div className="space-y-4 max-w-4xl mx-auto px-4">
              ...
              >
                We connect mentors directly with verified students and founders.
              </p>
              <p 
                style={{
                  fontFamily: 'var(--font-roboto), sans-serif',
              ...
              >
                No time-wasters. No non-serious people. Just quality connections and meaningful impact.
              </p>
              <p 
                style={{
                  fontFamily: 'var(--font-roboto), sans-serif',
              ...
              >
                Whether you want to mentor, network, or give back, CFC gives you a platform to make a real difference.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm md:text-base">
                India's first startup network built to empower mentors.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm md:text-base">
                <li><a href="#" className="hover:text-white transition-colors">Mentor Guide</a></li>
