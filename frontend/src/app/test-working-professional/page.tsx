...
import WorkingProfessionalMultiStepForm from '@/components/WorkingProfessionalMultiStepForm';

export default function TestWorkingProfessionalForm() {
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Working Professional Multi-Step Form Test
          </h1>
          <p className="text-xl text-gray-600">
            Testing the new working professional multi-step form implementation
          </p>
        </motion.div>

        <div className="bg-white rounded-2xl shadow-xl p-8">
          <WorkingProfessionalMultiStepForm
            userId="test-working-professional-123"
        ...
        <div className="mt-8 bg-blue-50 rounded-2xl p-6">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">
            Working Professional Form Features
          </h2>
          <ul className="space-y-2 text-blue-800">
            <li>✅ 4-step progressive form for working professionals</li>
            ...
            <li>✅ Blue color scheme for professional theme</li>
          </ul>
        </div>
      </div>
    </div>
